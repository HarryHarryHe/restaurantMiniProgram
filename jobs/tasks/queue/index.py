...
'''
python manager.py runjob -m queue/index 进入这个页面
'''
...
class JobTask():
    ...
    def handlePay(self, item):
        ...
        if pay_order_items:
            ...
            date_to = datetime.datetime.now().strftime("%Y-%m-31 23:59:59")  # 这个月结束时间
            for item in pay_order_items:
                ...
                tmp_stat_info = db.session.query(FoodSaleChangeLog,
                    ...
                    FoodSaleChangeLog.food_id == item.food_id).filter(FoodSaleChangeLog.created_time >= date_from,
        ...
        params = {
            ...
            "template_id": "i2G8GwCDQ3h5oXGuhXzOERA1b8wLjwNZtwK2aXB9l7E",  # 自己模板里边的id
